...
std::vector<torch::Tensor> distortion_loss_fw_cu(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(ws.scalar_type(), "distortion_loss_fw_cu_prefix_sums",
    ([&] {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(ws.scalar_type(), "distortion_loss_fw_cu",
    ([&] {
...
torch::Tensor distortion_loss_bw_cu(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(ws.scalar_type(), "distortion_loss_bw_cu",
    ([&] {
